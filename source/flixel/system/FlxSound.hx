...
class FlxSound extends FlxBasic
{
	 ...
	 * @param	AutoDestroy		Whether or not this FlxSound should be destroyed when the sound finishes playing.
	 * 							Default value is false, but `FlxG.sound.play()` and `FlxG.sound.stream()` will set it to true by default.
	 * @param	OnComplete		Called when the sound finished playing
	 * @return	This FlxSound (nice for chaining stuff together, if you're into that).
	 */
