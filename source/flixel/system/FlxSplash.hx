...
class FlxSplash extends FlxState
{
	...
	{
		_cachedBgColor = 0x2A1E2C;
		FlxG.camera.bgColor = 0x2A1E2C;
		...
		_colors = [0xFC7639, 0xFC7639, 0xFC7639, 0xFC7639, 0xFC7639];
		...
		var dtf = new TextFormat(FlxAssets.FONT_DEFAULT, 16, 0xFC7639);
