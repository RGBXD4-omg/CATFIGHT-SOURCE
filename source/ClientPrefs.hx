...
class ClientPrefs {
	...
	public static var tvResolution:String = 'Android';
	...
	public static function saveSettings() {
		...
		FlxG.save.data.tvResolution = tvResolution;
	...
	public static function getTVResolution():Float {
		switch (tvResolution) {
			case 'Original':
				return 1;
			case 'Half':
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.tvResolution != null) {
			tvResolution = FlxG.save.data.tvResolution;
		}
